...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        mainLayout.getChildren().addAll(scrollPane, userInput, sendButton); //Root node containing children nodes

        scene = new Scene(mainLayout); //Scene must have a root node
